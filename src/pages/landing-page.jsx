    ...
    <main>
      <section>
        <Wrapper>
          ...
          <ButtonNav onClick={() => navigate("signup")}>
          ...
          <Wrapper>
            ...
            <GridMembers>
              <ContentGrid>
                ...
                <ContentContact>
                  <a
                    href="https://github.com/sebastianterleira"
                    css={css`
                  ...
                  <a
                    href="https://www.linkedin.com/in/sebastian-terleira-8773a4247/"
                    css={css`
                      text-decoration: none;
                    `}
                  >
              ...
              <ContentGrid>
                ...
                <ContentContact>
                  <a
                    href="https://github.com/bettysl20"
                    css={css`
                      text-decoration: none;
                    `}
                  >
              ...
              <ContentGrid>
                ...
                <ContentContact>
                  <a
                    href="https://github.com/patico14"
                    css={css`
                      text-decoration: none;
                    `}
                  >
